    ...
    <div class="content">
      ...
      <slot>
        <template v-if="status === 503">
          <h1>Brzy budeme zpět!</h1>
          <div class="msg my-4">
            <p>
              Omlouváme se za nepříjemnosti, momentálně probíhá plánovaná údržba.
        ...
        <template v-else>
          <h1 class="error f-row-ac">
            ...
            <span>Chyba serveru</span>
          </h1>
          <div class="msg f-col-ac">
            <p class="my-4">
              Došlo k neočekávané chybě na straně serveru. Prosíme, zkuste to znovu později nebo nás kontaktujte.
              Děkujeme za vaši trpělivost.
            </p>
            <v-btn class="round n-case my-4" color="green" @click="reload">Zkusit znovu</v-btn>
          </div>
        </template>
      </slot>
    </div>
