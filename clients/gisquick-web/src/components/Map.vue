...
import RuianSearch from '@/components/RuianSearch.vue'

export default {
  name: 'Map',
  mixins: [Map],
  components: {
    ContentPanel, BottomToolbar, ScaleLine, MapAttributions, ToolsMenu, MapControl, MapTools, AppMenu, RuianSearch
  },
  refs: ['tools'],
  data () {
    return {
